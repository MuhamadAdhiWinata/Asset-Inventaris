<!-- components/features/kategori/KategoriTable.vue -->
<template>
  <div>
          ...
          <table class="w-full caption-bottom text-sm">
            <thead class="border-b bg-muted/40">
              <tr>
                ...
                <th class="h-12 px-4 text-left align-middle font-medium text-muted-foreground whitespace-nowrap">Masa Manfaat</th>
                <th class="h-12 px-4 text-left align-middle font-medium text-muted-foreground whitespace-nowrap">Metode Depresiasi</th>
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-4 py-3 align-middle text-sm">
                  {{ item.masaManfaatDefault }} tahun
                </td>
                <td class="px-4 py-3 align-middle text-sm">
                  {{ METODE_LABEL[item.metodeDefault] }}
                </td>
                <td class="px-4 py-3 align-middle">
                  <span
                    class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium"
                    :class="STATUS_KATEGORI_CONFIG[item.status].class"
                  >
                    {{ STATUS_KATEGORI_CONFIG[item.status].label }}
                  </span>
                </td>
                <td class="px-4 py-3 align-middle">
        ...
        <div class="md:hidden divide-y">
          ...
          >
            ...
            <div class="grid grid-cols-2 gap-x-4 gap-y-2 text-xs">
              ...
              <span>
                <span class="inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium" :class="STATUS_KATEGORI_CONFIG[item.status].class">
                  {{ item.status }}
                </span>
              </span>
            </div>
...
import {
  SearchIcon, Loader2Icon, RefreshCwIcon, TagIcon,
